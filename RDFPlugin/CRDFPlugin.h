...
constexpr auto MY_PLUGIN_DEVELOPER = "Kingfu Chan, modified by Ben Böckmann";
constexpr auto MY_PLUGIN_COPYRIGHT = "GPLv3 License, Copyright (c) 2023 Kingfu Chan, modifications Copyright (c) 2025 Ben Böckmann";
